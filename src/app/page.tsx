          ...
          <div className="my-auto">
            ...
            <div className="resume-item d-flex flex-column flex-md-row mb-5">
              <div className="resume-content mr-auto">
                ...
                <div className="subheading mb-3">Bacherlor in Software engineering</div>
                <p>CR: 7.0</p>
              </div>
              <div className="resume-date text-md-right">
          ...
          <div className="my-auto">
            ...
            <div className='skill-list'>
              <div  className='skill-item'>
                <div>
                  <ReactOriginal size={"50"}></ReactOriginal>
                  <p className='technology-center'>React</p>
                </div>
              </div>
              <div  className='skill-item'>
                <div>
                  <PythonOriginal size={"50"}></PythonOriginal>
                  <p className='technology-center'>Python</p>
                </div>
              </div>
              <div  className='skill-item'>
                <div>
                  <CsharpOriginal size={"50"}></CsharpOriginal>
                  <p className='technology-center'>C#</p>
                </div>
              </div>
              <div  className='skill-item'>
                <div>
                  <DotnetcoreOriginal size={"50"}></DotnetcoreOriginal>
                  <p className='technology-center'>.Net Core</p>
                </div>
              </div>
              <div  className='skill-item'>
                <div>
                  <AngularjsOriginal size={"50"}></AngularjsOriginal>
                  <p className='technology-center'>Angular</p>
                </div>
              </div>
              <div  className='skill-item'>
                <div>
                  <Css3Original size={"50"}></Css3Original>
                  <p className='technology-center'>CSS3</p>
                </div>
              </div>
              <div  className='skill-item'>
                <div>
                  <JavascriptOriginal size={"50"}></JavascriptOriginal>
                  <p className='technology-center'>Javascript</p>
                </div>
              </div>
              <div >
                <div>
                  <DockerOriginal size={"50"}></DockerOriginal>
